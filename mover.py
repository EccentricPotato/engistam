...
def MoveRight():
    ...
    tank_pair.on_for_degrees(left_speed = 100, right_speed = 0, degrees = 360, brake=True, block=True)


def MoveLeft():
    tank_pair = MoveTank(OUTPUT_A, OUTPUT_B)
    tank_pair.on_for_degrees(left_speed=0, right_speed=100, degrees=360, brake=True, block=True)
